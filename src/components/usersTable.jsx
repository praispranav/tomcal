...
class UsersTable extends Component {
  columns = [
    //   {path: '_id', label: 'Id'},
    {key:'avatar', label: 'avatar',content: user=>(	<span className="icon-img sm-r-5"><img style={{width: "15px",height: "15px"}} src={user.imageSrc} alt="" /></span>) } ,    
    ...
    {key:'edit',label: '',content: user => <Link to={`/clinic/users/${user._id}`}><i className="far fa-lg fa-fw m-r-10 fa-edit"></i></Link>},
