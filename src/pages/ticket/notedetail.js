						...
						<div className="wrapper clearfix">
							<div className="pull-left">
								<div className="btn-group m-r-5">
									<button className="btn btn-white btn-sm"><i className="fa fa-reply m-r-3 m-r-xs-0"></i> <span className="hidden-xs">Edit</span></button>
								</div>
								<div className="btn-group m-r-5">
							...
							<div className="pull-right">
								<div className="btn-group">
									<Link to="/ticket/inbox" className="btn btn-white btn-sm disabled"><i className="fa fa-arrow-up"></i></Link>
									<Link to="/ticket/inbox" className="btn btn-white btn-sm"><i className="fa fa-arrow-down"></i></Link>
								</div>
								<div className="btn-group m-l-5">
									<Link to="/ticket/inbox" className="btn btn-white btn-sm"><i className="fa fa-times"></i></Link>
								</div>
							</div>
						</div>
										...
										<div className="wrapper">
											...
											<ul className="attached-document clearfix">
												<li className="fa-file">
													...
													<div className="document-name"><Link to="/ticket/detail">flight_ticket.pdf</Link></div>
												</li>
												<li className="fa-camera">
													...
													<div className="document-name"><Link to="/ticket/detail">front_end_mockup.jpg</Link></div>
												</li>
											</ul>
