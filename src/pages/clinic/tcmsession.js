...
schema = Joi.object({
	...
	mapToViewModel(tcmsession) {
		return {
		  ...
		  profile: tcmsession.profile,
		  email: tcmsession.email,
		  firstName: tcmsession.firstName,
		  lastName: tcmsession.firstName,
		  initials: tcmsession.initials,
		  prefix: tcmsession.prefix,
		  country: tcmsession.country,
		  appointmentType: tcmsession.appointmentType,
		  sessionType: tcmsession.sessionType,
		  chiefComplaint: tcmsession.chiefComplaint,
		  symptoms: tcmsession.symptoms,
		  WesternDisease: tcmsession.WesternDisease,
		  currentTreatment: tcmsession.currentTreatment,
		  diseasesIllnesses: tcmsession.diseasesIllnesses,
		  surgeries: tcmsession.surgeries,
		  medicamentsSupplements: tcmsession.medicamentsSupplements,
		  allergies: tcmsession.allergies,
		  pregnancies: tcmsession.pregnancies,
		  familyRole: tcmsession.familyRole,
		  familyDisease: tcmsession.familyDisease,
		  familyDiseaseYear: tcmsession.familyDiseaseYear,
		  familyDiseaseState: tcmsession.familyDiseaseState,
		  medicalHistoryNote: tcmsession.medicalHistoryNote,
		  socialRelationship: tcmsession.socialRelationship,
		  habits: tcmsession.habits,
		  occupation: tcmsession.occupation,
		  occupationState: tcmsession.occupationState,
		  sport: tcmsession.sport,
		  sportFrequency: tcmsession.sportFrequency,
		  hobbies: tcmsession.hobbies,
		  smoking: tcmsession.smoking,
		  sugar: tcmsession.sugar,
		  alcohol: tcmsession.alcohol,
		  tea: tcmsession.tea,
		  coffee: tcmsession.coffee,
		  heroin: tcmsession.heroin,
		  weight: physicalcondition.weight,
		  height: physicalcondition.height,
		  vitality: tcmsession.vitality,
		  appearance: tcmsession.appearance,
		  appearanceNote: tcmsession.appearanceNote,
		  faceColorLustre: tcmsession.faceColorLustre,
		  tongueShape: tcmsession.tongueShape,
		  tongueColor: tcmsession.tongueColor,
		  tongueQuality: tcmsession.tongueQuality,
		  tongueNote: tcmsession.tongueNote,
		  respiration: tcmsession.respiration,
		  speech: tcmsession.speech,
		  cough: tcmsession.cough,
		  odor: tcmsession.odor,
		  appetite: tcmsession.appetite,
		  appetiteNote: tcmsession.appetiteNote,
		  vomiting: tcmsession.vomiting,
		  vomitingNote: tcmsession.vomitingNote,
		  diet: tcmsession.diet,
		  dietNote: tcmsession.dietNote,		  
		  taste: tcmsession.taste,
		  thirst: tcmsession.thirst,		  
		  defecation: tcmsession.defecation,
		  urination: tcmsession.urination,		  
		  urineColor: tcmsession.urineColor,		  
		  sleeping: tcmsession.sleeping,
		  thermalFeeling: tcmsession.thermalFeeling,		  
		  perspiration: tcmsession.perspiration,		  
		  head: tcmsession.head,
		  eyes: tcmsession.eyes,
		  ears: tcmsession.ears,
		  nose: tcmsession.nose,
		  throat: tcmsession.throat,		  
		  painLocation: tcmsession.painLocation,		  
		  painNature: tcmsession.painNature,
		  menstruationHistory: tcmsession.menstruationHistory,
		  leukorrhea: tcmsession.leukorrhea,		  
		  emotionalStatus: tcmsession.emotionalStatus,		  
		  emotionalNote: tcmsession.emotionalNote,		  
		  interviewNote: tcmsession.interviewNote ,		  
		  
		  pulseSpeed: tcmsession.pulseSpeed,
		  pulseDepth: tcmsession.pulseDepth,		  
		  pulseStrength: tcmsession.pulseStrength,		  
		  pulseShape: tcmsession.pulseShape,
		  pulseTension: tcmsession.pulseTension,
		  pulseRhythm: tcmsession.pulseRhythm,
		  pulseNote: tcmsession.pulseNote,		  
		  physicalAppearance: tcmsession.physicalAppearance,
		  physicalPalpationEpigastrium: tcmsession.physicalPalpationEpigastrium,
		  physicalPalpationEpigastriumNote: tcmsession.physicalPalpationEpigastriumNote,		  
		  physicalPalpationAbdomen: tcmsession.physicalPalpationAbdomen,
		  physicalPalpationAcupoint: tcmsession.physicalPalpationAcupoint,
		  rangeMotion: tcmsession.rangeMotion,
		  painLevel: tcmsession.painLevel,		  		  
		  physicalExaminationNote: tcmsession.physicalExaminationNote,		  
		  TCMDiagnosis: tcmsession.TCMDiagnosis,
		  principleTreatment: tcmsession.principleTreatment,		  
		  acuPoints: tcmsession.acuPoints,		  
		  stimulationDuration: tcmsession.stimulationDuration,
		  stimulationMethod: tcmsession.stimulationMethod,
		  needleManipulation: tcmsession.needleManipulation,		  
		  ...
		  materiaMedica1: tcmsession.materiaMedica1,
		  mmDosage1: tcmsession.mmDosage1,
		  mmUnit1: tcmsession.mmUnit1,
		  herbalFormula2: tcmsession.herbalFormula2,		  
		  materiaMedica2: tcmsession.materiaMedica2,
		  mmDosage2: tcmsession.mmDosage2,
		  mmUnit2: tcmsession.mmUnit2,		  
		  dietTherapy: tcmsession.dietTherapy,		  
		  recommendation: tcmsession.recommendation,		  		  
		  createdOn: new Date(tcmsession.date),		  
		};
	  }
							...
							<Panel>
								...
								<PanelBody className="panel-form">
									<form className="form-horizontal form-bordered" onSubmit={this.handleSubmit} >
										...
										<div className="form-group row">
											<label className="col-lg-4 col-form-label" htmlFor="tcmsessionname">UserName</label>
											<div className="col-lg-8">
												<div className="row row-space-10">
													<input type="text" id="tcmsessionname" name="tcmsessionname"
														value={data.tcmsessionname}
														className="form-control m-b-5"
														placeholder="Enter tcmsessionname"
														onChange={this.handleChange}
														autoFocus />
													{errors.tcmsessionname && (
