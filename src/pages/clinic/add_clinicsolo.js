		...
		return (
			<div>
				<ol className="breadcrumb float-xl-right">
					...
					<li className="breadcrumb-item"><Link to="/form/plugins">ClinicSolos</Link></li>
					<li className="breadcrumb-item active">Add Clinic-solo</li>
				</ol>
				<h1 className="page-header">Add Clinic/Solo <small>Clinic-solo-registration-form</small></h1>
				...
				<div className="row">
					<div className="col-xl-10">
						...
						8				<label className="col-lg-4 col-form-label">Password</label>
                                    ...
                                    <div className="form-group row">
										<label className="col-lg-4 col-form-label">Select Clinicsolo-type</label>
										<div className="col-lg-8">
											<Select options={this.clinicsoloOptions} />
										</div>
									</div>
